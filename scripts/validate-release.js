...
pushCheck(checks, 'package version', version === '3.0.0', version);
pushCheck(checks, 'README current release', files.readme.includes('**v3.0.0** (2026-05-28)'), 'README current release block');
...
pushCheck(checks, 'CHANGELOG current version', files.changelog.includes('## [3.0.0] - 2026-05-28'), 'CHANGELOG heading');
...
pushCheck(checks, 'RELEASE_NOTES current version', files.releaseNotes.includes('## v3.0.0 (2026-05-28)'), 'RELEASE_NOTES heading');
